...
const { apiStatusCheck } = require('../index.js');

describe('apiStatusCheck', () => {
  it('should be a function', () => {
    (typeof apiStatusCheck).should.equal('function');
  });

  it("should pass an array with an error message when npmmfp's diary is not 'public'", done => {
  ...
  it("should pass an array with an error message when npmmfpprivate's diary is not 'private'", done => {
    nock('https://www.myfitnesspal.com')
      .get('/reports/printable_diary/npmmfp')
      .replyWithFile(200, `${__dirname}/mocks/diary-public.html`)
      .get('/reports/printable_diary/npmmfpprivate')
  ...
  it('should pass an array with an error message when invalid diaries are handled incorrectly', done => {
    nock('https://www.myfitnesspal.com')
      .get('/reports/printable_diary/npmmfp')
      .replyWithFile(200, `${__dirname}/mocks/diary-public.html`)
      .get('/reports/printable_diary/npmmfpprivate')
  ...
  it("should pass an array with an error message when fetching all nutrient data from a date doesn't work", done => {
    nock('https://www.myfitnesspal.com')
      .get('/reports/printable_diary/npmmfp')
      .replyWithFile(200, `${__dirname}/mocks/diary-public.html`)
      .get('/reports/printable_diary/npmmfpprivate')
  ...
  it('should pass an array with multiple error messages when encountering multiple broken functions', done => {
    nock('https://www.myfitnesspal.com')
      .get('/reports/printable_diary/npmmfp')
      .replyWithFile(200, `${__dirname}/mocks/diary-private.html`)
      .get('/reports/printable_diary/npmmfpprivate')
